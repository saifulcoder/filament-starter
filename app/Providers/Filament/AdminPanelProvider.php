    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->navigation(function (\Filament\Navigation\NavigationBuilder $builder): \Filament\Navigation\NavigationBuilder {
                ...
                // Add dynamic navigation groups from database
                $dynamicGroups = \App\Services\DynamicNavigationService::getAllNavigationGroups();
                ...
                $builder->groups([
                    \Filament\Navigation\NavigationGroup::make('Settings')
                        ->items([
                            ...(\App\Filament\Resources\NavigationResource::getNavigationItems()),
                        ]),
                    \Filament\Navigation\NavigationGroup::make('Filament Shield')
                        ->items([
                            ...(\BezhanSalleh\FilamentShield\Resources\Roles\RoleResource::getNavigationItems()),
                        ]),
                ]);
